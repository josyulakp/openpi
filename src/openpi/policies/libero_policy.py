    ...
    def __call__(self, data: dict) -> dict:
        ...
        inputs = {
            ...
            "image_mask": {
                ...
                # "wrist": np.False_ if mask_padding else np.True_,
            },
        }
        ...
        # stored in "annotation.human.action.task_description"; the output dict always needs to have the key "prompt").
...
class LiberoOutputs(transforms.DataTransformFn):
    ...
    def __call__(self, data: dict) -> dict:
        ...
        return {"action": np.asarray(data["action"][:, :8])}
